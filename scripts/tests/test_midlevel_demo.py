...
Garantit la présence du corpus de démo.
Résout le profil ideo_quick avec overrides pour web1.
Exécute prepare -> train -> evaluate (sklearn) via `make run`.
Vérifie la présence des artefacts clés.
"""
